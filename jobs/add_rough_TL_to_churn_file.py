...
def check_for_matching_entry(trg,source_subentry):#source_subeSntry = jsonDict["Data"][cid][source]
...
def add_to_data(sourceLang, targetLang, rough_t_db, rough_t_xliff_folder):
    xliff_folder = rough_t_xliff_folder
    churn_data_path = rough_t_db
    ...
    try:
        ...
        print("An error occurred while attempting to update rough T data structure")
        return 1
    ...
    if edit_flag:
        try:
            ...
            print("An error occurred while attempting to save rough T to json file")
            return 1
